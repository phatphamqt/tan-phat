...
// let name = {name: "Xiaomi rice cooker"}
// let price = {price: 1700}
// let brand = {brand: "Xiaomi"}
...
//3
//3.1 Object
//3.2 "hits" is key variable
//3.2
// for(i=0;i<jobdata.hits.length;i++){
//     console.log("Title: "+ jobdata.hits[i].jobTitle)
//     console.log("Salary: "+ jobdata.hits[i].jobSalary)
//     console.log("Location: "+ jobdata.hits[i].locations)
//     console.log("Benefits: ")
//     for(a=0;a<jobdata.hits[i].benefits.length;a++){
//         console.log("-"+jobdata.hits[i].benefits[a].benefitValue)
//     }
//     console.log("Skills: ")
//     for(a=0;a<jobdata.hits[i].skills.length;a++){
//         console.log("-"+jobdata.hits[i].skills[a])
//     }
//     console.log("-------------------------------------------------------------------")
// }
...
// let dict={  
// key: ["debug","done","defect","pm","ui/ux"],
// value: ["The process of figuring out why your program has a certain error and how to fix it", 
...
// //4.1 4.2
// let s=prompt("Search what?")
// let dictionary=function(){ 
// if(dict.key.indexOf(s)==-1){
//     console.log("the word does not exist, we will create new key and explaination")
//     dict.key.push(s)
//     console.log(dict.key)
//     let ndict=prompt("Enter new explaination:")
//     dict.value.push(ndict)
//     console.log(dict.value[dict.value.indexOf(ndict)])
//     dictionary()
// }else{
//     n= dict.key.indexOf(s)
//     console.log(dict.value[n])
// }
// }
// dictionary()
...
// console.log("Name: "+ phone[pos-1 ].Name)
// console.log("Brand: "+ phone[pos-1 ].Brand)
// console.log("Price: "+ phone[pos-1].Price)
// console.log("Color: "+ phone[pos-1].Color)
// console.log("Category: "+ phone[pos-1].Category)
// console.log(phone[0].Category)
// console.log(phone.length)

// let cat=prompt("Enter your category:")
// for(i=0;i<phone.length;i++){ 
// if(phone[i].Category==cat){
//     console.log("Name: "+ phone[i].Name)
//     console.log("Price: "+ phone[i].Price)
//     console.log("--------------------------")
// }
...
// phone[0].provider= ["phukienzero"," dientuccc" ];
// phone[1].provider= ["Tgdd","Ddghn", "Vhstore" ];
// phone[2].provider= ["Tgdd"];
// phone[3].provider= ["Tgdd"];

// for(i=0;i<phone.length;i++){
//     console.log("#"+(i+1)+". "+ phone[i].Name )
//     console.log("Price: "+ phone[i].Price)
//     console.log("Providers: "+ phone[i].provider)
// }
...
// console.log("Hi there, this is your learning tasks to a front-end developer career: ")
...
//     a={task : prompt("New Task Name: "),
//     complete: "False",}
//     process.push(a)
//     console.log(process)
// }
// else if (command=="update"){
//     b=prompt("Enter position to update:")
// newtask=prompt("Enter new task:")
// process[b-1].task=newtask
// console.log(process)
// }
// else if(command=="complete"){
//     c=prompt("Enter task position to complete:")
//     process[c-1].complete="True"
//     console.log(process)
// }
// else {
//     d=prompt("Enter position to delete")
//     process.splice(d-1,1)
//     console.log(process)
// }
// }
