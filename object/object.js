...
//3.1 The outermost layer data type is Object
console.log(typeof hits)
//3.2 The data type of hits is undefined

//3.3

const dict={
    key:"debug",
    explaination:["The process of figuring out why your program has a certain error and how to fix it","When your task is complete, the only thing you have to do is to wait for users to use it (no additional codes or actions needed)" ]
}
